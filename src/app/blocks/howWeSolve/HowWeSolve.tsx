...
import './HowWeSolve.css'

export const HowWeSolve: React.FC<HowWeSolveProps> = ({
  title,
  customerServiceDesc,
  costDesc,
  emissionsDesc,
  ...
  return (
    <section className="sz-net0-section sz-section">
      <div className="sz-container">
        <h2 className="sz-net0-title">{title || 'See our net-zero emission data how we slove'}</h2>
        <div className="sz-net0-cards-wrap">
          <div className="sz-net0-card">
            <div className="sz-net0-card-content sz-customer-service">
              <div>
                <h3 className="sz-net0-card-title">24/7</h3>
                <div className="sz-net0-card-subtitle-wrap">
                  <svg
          ...
          <div className="sz-net0-card">
            <div className="sz-net0-card-content sz-the-cost">
              <div>
                <h3 className="sz-net0-card-title">1/3</h3>
                <div className="sz-net0-card-subtitle-wrap">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
          ...
          <div className="sz-net0-card">
            <div className="sz-net0-card-content sz-emissions-reduction">
              <div>
                <h3 className="sz-net0-card-title">30%</h3>
                <div className="sz-net0-card-subtitle-wrap">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                  ...
                  >
                    <path
                      d="M2.08268 16.833H5.58268C5.58268 16.833 6.74935 16.833 6.74935 17.9997V20.333C6.74935 20.333 6.74935 21.4997 5.58268 21.4997H2.08268C2.08268 21.4997 0.916016 21.4997 0.916016 20.333V17.9997C0.916016 17.9997 0.916016 16.833 2.08268 16.833Z"
                      fill="currentColor"
                    />
                    <path
                      d="M10.2507 8.66699H13.7507C13.7507 8.66699 14.9173 8.66699 14.9173 9.83366V20.3337C14.9173 20.3337 14.9173 21.5003 13.7507 21.5003H10.2507C10.2507 21.5003 9.08398 21.5003 9.08398 20.3337V9.83366C9.08398 9.83366 9.08398 8.66699 10.2507 8.66699Z"
                      fill="currentColor"
                    />
                    <path
                      d="M18.4167 0.5H21.9167C21.9167 0.5 23.0833 0.5 23.0833 1.66667V20.3333C23.0833 20.3333 23.0833 21.5 21.9167 21.5H18.4167C18.4167 21.5 17.25 21.5 17.25 20.3333V1.66667C17.25 1.66667 17.25 0.5 18.4167 0.5Z"
                      fill="currentColor"
                    />
                  </svg>
                  <p className="sz-net0-subtitle">Emissions Reduction</p>
                </div>
              </div>
              <p className="sz-net0-card-desc">
                {emissionsDesc || 'Achieve measurable carbon reduction within the first year.'}
              </p>
            </div>
          </div>
          <div className="sz-net0-card">
            <div className="sz-net0-card-content sz-faster-reporting">
              <div>
                <h3 className="sz-net0-card-title">50%</h3>
                <div className="sz-net0-card-subtitle-wrap">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
